...
namespace CMCS.Controllers
{
    public class RequestController : Controller
    {
        ...
        private void HR_View_GenerateReport()
        {
            ...
            XPen pen1 = new XPen(XColor.FromArgb(0, 0, 0), 2);
            ...
            graphics.DrawString("Total number of claims: 0", text_font, brush1, (PAGE_WIDTH / 2) - 210, 290);
            graphics.DrawString("Total number of approved claims: 0", text_font, brush1, (PAGE_WIDTH / 2) - 210, 310);
            graphics.DrawString("Total number of rejected claims: 0", text_font, brush1, (PAGE_WIDTH / 2) - 210, 330);
            graphics.DrawString("Total number of pending claims: 0", text_font, brush1, (PAGE_WIDTH / 2) - 210, 350);

            graphics.DrawLine(pen1, (PAGE_WIDTH / 2) - 210, 370, (PAGE_WIDTH / 2) + 210, 370);

            graphics.DrawString("Date and Time: ", text_font, brush1, (PAGE_WIDTH / 2) - 210, 390);
            graphics.DrawString("Generated by: ", text_font, brush1, (PAGE_WIDTH / 2) - 210, 410);
